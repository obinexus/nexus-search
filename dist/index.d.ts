...
type DocumentValue = PrimitiveValue | ArrayValue | Record<string, any>;
...
interface NexusDocument extends Omit<IndexedDocument, 'fields' | 'metadata'> {
    fields: NexusFields;
